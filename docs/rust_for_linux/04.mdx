...
module_platform_driver! {
    ...
    name: "rustkbd",
    authors: ["IP Workshop"],
    description: "Keyboard driver sample",
    license: "GPL",
}
struct KbdDriver {
...
4. Write a `platform` driver that registers for the `KBD0001` device and append onto the qemu `-append` parameter `i8042.nopnp=1` to make sure the ps2 driver doesnt catch your interrupts. Print a message from the `probe` function to test if it is called.
