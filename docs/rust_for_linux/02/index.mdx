...
8. Write a `poweroff` driver that stops the virtual machine. Make sure you read the documentation for [`x86_64`](02/poweroff_x86) or [`arm64`](02/poweroff_arm64) depeding on your developmenrt platform.
