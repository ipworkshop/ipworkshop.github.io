...
const config: Config = {
  title: 'IP Workshop Summer School Developer',
  tagline: 'The Developer Website of the IP Workshop Summer School',
  ...
  organizationName: 'ipworkshop', // Usually your GitHub org/user name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'Instagram',
              href: 'https://instagram.com/ipworkshop.ro',
            },
          ],
        },
        {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Asociatia IP Workshop. Built with Docusaurus.`,
    },
    prism: {
